(function(k, d) {
    ...
    function ca(a, b) {
        ...
        this.pan = function(a, b) {
            ...
            if (f.object instanceof d.PerspectiveCamera) {
                ...
                f.object instanceof d.OrthographicCamera ? (f.panLeft(a * (f.object.right - f.object.left) / e.clientWidth), f.panUp(b * (f.object.top - f.object.bottom) / e.clientHeight)) : console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.")
        };
        this.momentum =
        function() {
        ...
        this.update = function(a) {
            if (!1 !== c.enabled && c.deviceOrientation) {
                ...
                if (0 == c.screenOrientation) {
                    ...
                    180 == c.screenOrientation ? (q = new d.Vector3(1, 0, 0), m.setFromAxisAngle(q, g)) : 90 == c.screenOrientation ? (q = new d.Vector3(0, 1, 0), m.setFromAxisAngle(q, g)) : -90 == c.screenOrientation && (q = new d.Vector3(0,
                ...
                if (1 === e)
                    if (0 < this._repeat) {
                        ...
                        for (b in this._valuesStartRepeat)
                            ...
                            this._yoyo && (e = this._valuesStartRepeat[b], this._valuesStartRepeat[b] = this._valuesEnd[b], this._valuesEnd[b] = e),
                        ...
                        for (b = this._chainedTweens.length; a < b; a++)
                            this._chainedTweens[a].start(this._startTime +
                            this._duration);
                        return !1
                    }
                return !0
    ...
    r.prototype = Object.assign(Object.create(d.Mesh.prototype), {
        ...
        dispose: function() {
            function a(b) {
                for (var c =
                    b.geometry, d = b.material, h = b.children.length - 1; 0 <= h; h--)
                    a(b.children[h]),
    ...
    z.prototype = Object.assign(Object.create(r.prototype), {
        ...
        setVideoTexture: function(a) {
            if (a)
                return a = new d.VideoTexture(a), a.minFilter = d.LinearFilter, a.magFilter = d.LinearFilter, a.format = d.RGBFormat,
    ...
    ea.prototype = Object.assign(Object.create(d.EventDispatcher.prototype), {
        ...
        setupContainer: function(a) {
            if (a)
                return a._width = a.clientWidth, a._height = a.clientHeight, a;
        ...
        update: function() {
            ...
            this.scene.traverse(function(a) {
                if (a instanceof
                y && a.element && (this.hoverObject === a || "none" !== a.element.style.display || a.element.left && "none" !== a.element.left.style.display || a.element.right && "none" !== a.element.right.style.display))
